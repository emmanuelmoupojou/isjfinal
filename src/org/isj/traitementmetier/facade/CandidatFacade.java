...
/**
 * cette classe permet de créer, lire, supprimer et mettre à jour un objet Candidat dans la base de données
 *
...
public class CandidatFacade extends AbstractFacade<Candidat> {
    ...
    /**
      * fonction qui permet de créer un objet Candidat en base de données en utilisant les paramètres du constructeur
     * @param libelle
     * @param description
     * @param nom
     * @param prenom
    ...
    /**
     * fonction qui permet de supprimer un objet Candidat
     * @param candidat
    ...
    /**
     * fonction qui permet de lister tous les objets de la table Candidat en BD
     * @return une liste d'objets Candidat
     */
    ...
    /**
     *fonction qui permet de lister les objets Candidat selon la requete passée en paramètre
     * @param requete
     * @return une liste d'objets Candidat
     */
