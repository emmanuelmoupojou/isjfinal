...
public class CandidatController implements Initializable {
    ...
    @FXML
    private TableColumn<Candidat, Long> classecolumn;
    ...
    public void listCandidat() throws SQLException {
        ...
        if (Connexion.peutLire(Candidat.class)) {
            ...
            classecolumn.setCellValueFactory(cellData -> new SimpleLongProperty(cellData.getValue().getClasse().getCode()).asObject());
    ...
    public void handleEnregistrer() {
        ...
        if (Connexion.peutLire(Candidat.class) || Connexion.peutModifier(Candidat.class)) {
            try {
                ...
                String resultat;
                if (candidatSelectionne == null)
                    resultat = candidatFacade.enregistrer("", "", nomCandidat, prenomCandidat, emailCandidat, Integer.parseInt(telephoneCandidat), dateNaissance, sexe, Personne.Statut.ACTIVE, nompereCandidat, profpereCandidat, Integer.parseInt(telmereCandidat), Integer.parseInt(telpereCandidat), nommereCandidat, profmereCandidat, regionO, ecoleO, classeEtudiant);
                else
                    resultat = candidatFacade.modifier(candidatSelectionne, "", "", nomCandidat, prenomCandidat, emailCandidat, Integer.parseInt(telephoneCandidat), dateNaissance, sexe, Personne.Statut.ACTIVE, nompereCandidat, profpereCandidat, Integer.parseInt(telmereCandidat), Integer.parseInt(telpereCandidat), nommereCandidat, profmereCandidat, regionO, ecoleO, classeEtudiant);
