...
public class AnonymatController implements Initializable{
    ...
    @FXML
    private TableColumn<Anonymat, Double> notecolumn;

    @FXML
    private TableColumn<Anonymat, String> candidatinscritcolumn;
    ...
    public void listAnonymat() throws SQLException {
        ...
        if (Connexion.peutLire(Anonymat.class)) {
            ...
            candidatinscritcolumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getEstInscrit().getCandidatInscrit().getNom()));
    ...
    public void handleCandidat() throws Exception{
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(Appli.class.getResource("../view/Candidats.fxml"));
        BorderPane page = loader.load();
        Stage dialogStage = new Stage();
